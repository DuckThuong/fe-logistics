    ...
    <section className="hk-cta section" ref={ref}>
      ...
      <div className="container">
        <div className="hk-cta__inner">
          <div className={`hk-cta__badge ${animateClass('fade-down', inView, 1)}`}>🚀 Bắt đầu ngay hôm nay</div>
          ...
          <p className={`hk-cta__desc ${animateClass('fade-up', inView, 3)}`}>
            Tiếp cận công xưởng sản xuất lớn nhất thế giới. Rất nhiều hàng
            hóa đang chờ bạn khám phá với mức giá tốt nhất.
          </p>

          <div className={`hk-cta__actions ${animateClass('fade-up', inView, 4)}`}>
            <Button
              type="primary"
              size="large"
          ...
          <div className={`hk-cta__trust ${animateClass('fade-in', inView, 5)}`}>
            {['✅ Đăng ký miễn phí', '✅ Không cần CMND', '✅ Hỗ trợ ngay 24/7'].map((t) => (
              <span key={t} className="hk-cta__trust-item">{t}</span>
            ))}
          </div>
        </div>
      </div>
